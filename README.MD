...
## Features
* **Nearly Easy Setup**: You can easily setup this bot and use it under 10 minutes (without reCaptcha; Signing up for reCaptcha and registering domain required more than 30 extra minutes)
